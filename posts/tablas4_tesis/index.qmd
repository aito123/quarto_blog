...
rbind(
  ...
  ggplot(aes(y=sub, x=fct_relevel(fct_reorder(var1, var_orden$values, min), "Nacional", after = Inf))) +
...
- Se filtra Trabajador Familiar No Remunerado y otro dado que no cuentan con una remuneración.
