...
Se elaboró una base de datos unificada que incluye el año 2019 y 2020. El proceso de unificación se puede consultar en el archivo `base_de_datos.Rmd`. De manera exploratoria podemos apreciar que la base tiene las siguientes características.

```{r}
#BASE UNIFICADA
base<-read_sav(here("bases_datos/enaho_2019_2020.sav"))
