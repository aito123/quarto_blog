...
base2<-
  base1 %>% 
  mutate(
    #ocupacion principal fix bug, se arregló filtrando otros
    p507=case_when(
      p507 %in% 1~1,
      p507 %in% 2~2,
      p507 %in% 3~3,
    ...
    p507=labelled_spss(p507,
                       label = "Ud. se desempeño en su ocupación principal o negocio como:",
                       labels = c("Empleador o patrono"=1,"Trabajador Independiente"=2,"Empleado"=3,
                                  "Obrero"=4,"Trabajador Familiar No Remunerado"=5,"Trabajador del Hogar"=6,
                                  "Otro"=7)),
...
#   count(ing_cap)
# 
# base2 %>% filter(dominio %in% 8 & ano %in% "2019") %>%
...
#1920.38439941406, 2420.76844618056, 2773.28385416667, 3153.9033203125, 3264.26846590909, 3283.44856770833, 4211.30403645833
