...
En caso no cuente con las bases de datos en su computadora, puede correr el bloque de código que descargará las bases de la página del INEI en un directorio temporal.
