...
#| column: screen-inset-right
m05_2019 %>%
  select(CODPERSO,P507,P207,P203,P208A,I520,I538A1,I538E1,OCU500,D524A1,OCUPINF,EMPLPSEC,FAC500A)%>%
  sjPlot::view_df()
...
enaho2019<-
  #modulo5 = base
  m05_2019 %>% select(ids,CODPERSO,P507,P207,P203,P208A,I520,I538A1,I538E1,OCU500,D524A1,OCUPINF,EMPLPSEC,FAC500A) %>% 
  #modulo1
...
enaho2020<-
  #modulo5 = base
  m05_2020 %>% select(ids,CODPERSO,P507,P207,P203,P208A,I520,I538A1,I538E1,OCU500,D524A1,OCUPINF,EMPLPSEC,FAC500A) %>% 
  #modulo1
...
enaho2021<-
  #modulo5 = base
  m05_2021 %>% select(ids,CODPERSO,P507,P207,P203,P208A,I520,I538A1,I538E1,OCU500,D524A1,OCUPINF,EMPLPSEC,FAC500A) %>% 
  #modulo1
