...
#| column: screen-inset-right
m05_2019 %>%
  select(codperso, p301a, p507, p207, p208a, ocu500, ocupinf, emplpsec, i524a1, d529t, i530a, d536, i538a1, d540t, i541a, d543, d544t, fac500a)%>%
  sjPlot::view_df()
...
enaho2019<-
  #modulo5 = base
  m05_2019 %>% select(ids,codperso, p301a, p507, p207, p208a, ocu500, ocupinf, emplpsec, i524a1, d529t, i530a, d536, i538a1, d540t, i541a, d543, d544t, fac500a) %>% 
  #modulo3
...
enaho2020<-
  #modulo5 = base
  m05_2020 %>% select(ids,codperso, dominio, estrato, p301a, p507, p207, p208a, ocu500, ocupinf, emplpsec, i524a1, d529t, i530a, d536, i538a1, d540t, i541a, d543, d544t, fac500a) %>% 
  #modulo3
...
enaho2021<-
  #modulo5 = base
  m05_2021 %>% select(ids,codperso, dominio, estrato, p301a, p507, p207, p208a, ocu500, ocupinf, emplpsec, i524a1, d529t, i530a, d536, i538a1, d540t, i541a, d543, d544t, fac500a) %>% 
  #modulo3
...
enaho19_20_21_1<-
  ...
  mutate(
    ...
    area = case_when(estrato <= 5 ~ 1,
                     TRUE ~ 2), 
    area = labelled_spss(area, label = "Área", labels = c("Urbano"=1, "Rural"=2)),
  ) %>% 
  #filtrar población objetivo
  filter(area %in% 1 & ocu500 %in% 1) %>% 
  mutate(
    #gedad
...
m05_2017_spss_2<-
  ...
  mutate(
    ...
    across(c(i524a1, d529t, i530a, d536, i538a1, d540t, i541a, d543, d544t), ~replace(., is.na(.), 0)),
    ingtrabw = rowSums(across(c(i524a1, d529t, i530a, d536, i538a1, d540t, i541a, d543, d544t))),#ptrme estaba sumando variables que no eran...
    ingtrabw = labelled_spss(ingtrabw, label = "ingreso por trabajo anual"),
    ingtra_n = ingtrabw / 12,
    ingtra_n = labelled_spss(ingtra_n, label = "ingreso por trabajo mensual"),
